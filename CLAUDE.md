...
5. `output.py` — Replaces `{N}` placeholders with real tag XML from source. Generates TMX, then parses the written file back (`validate_tmx`) before reporting success.
